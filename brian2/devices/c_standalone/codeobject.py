...
class CStandaloneCodeObject(CodeObject):
    '''
    ...
    '''
    templater = Templater('brian2.devices.c_standalone',
...
codegen_targets.add(CStandaloneCodeObject)
