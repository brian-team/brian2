...
sigma_ear = .1
eqs_ear = '''
dx/dt=(sound-x)/tau_ear+sigma_ear*(2./tau_ear)**.5*xi : 1 (active)
...
'''
receptors = NeuronGroup(2, eqs_ear, threshold='x>1', reset='x=0', language=language)
receptors.refractory = 2*ms
