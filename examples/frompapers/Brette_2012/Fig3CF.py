...
compartment16=morpho.axon[location16].indices()[0]
compartment12=morpho.axon[location12].indices()[0]
neuron.v=EL
...
plot(M.t/ms,M.v[compartment16]/mV,'k')
plot(M.t/ms,M.m[compartment16]*(80+60)-80,'k--') # open channels
ylim(-80,60)
xlabel('Time (ms)')
ylabel('V (mV)')
...
dm40=diff(M.v[compartment16])/defaultclock.dt
plot((M.v[0]/mV)[1:],dm,'r')
plot((M.v[compartment16]/mV)[1:],dm40,'k')
xlim(-80,40)
xlabel('V (mV)')
ylabel('dV/dt (V/s)')
title('Phase plot')
...
plot((M.v[0]/mV)[1:],dm,'r')
plot((M.v[compartment16]/mV)[1:],dm40,'k')
plot((M.v[0]/mV)[1:],10*volt/second+0*dm,'k--')
xlim(-70,-40)
ylim(0,20)
xlabel('V (mV)')
ylabel('dV/dt (V/s)')
