...
spike_t = numpy.fromfile('STDP_standalone/results/spikemonitor_codeobject_t', dtype=numpy.float64)
spike_i = numpy.fromfile('STDP_standalone/results/spikemonitor_codeobject_i', dtype=numpy.int32)
rate = numpy.fromfile('STDP_standalone/results/ratemonitor_codeobject_rate', dtype=numpy.float64)
