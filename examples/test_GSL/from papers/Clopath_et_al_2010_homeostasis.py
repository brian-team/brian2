...
Edit on April 23rd 2017 by Charlee Fletterman:
Wanted to test GSL with this simulation, but simulation doesn't run with cython through brian code
In synaptic code following line of code:
w_ampa = clip(w_ampa + w_plus, 0, w_max) gives the following error:
