...
August 1st, 2017: adapted to run with GSL by Charlee Fletterman.
Tried with: weave, cython and cpp_standalone. Figure looks the same as conventional brian (by eye)
Note: the stateupdater of the first NeuronGroup, legs, was left to stay 'Euler' because its equations contain
...
'''
from brian2 import *
set_device('cpp_standalone', build_on_run=False) # comment out if you want to test runtime device
